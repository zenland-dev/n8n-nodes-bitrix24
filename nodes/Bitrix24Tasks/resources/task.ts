...
function taskFieldOptions(forUpdate: boolean): INodeProperties[] {
	const options: INodeProperties[] = [
		...
		{ displayName: 'CRM Records', name: 'crmRecords', type: 'string', default: '', placeholder: 'D_10, C_7, T4d2_3', description: 'Comma-separated CRM records with a type prefix: L_ lead, D_ deal, C_ contact, CO_ company, T&lt;hex type&gt;_ smart process' },
		...
		{ displayName: 'Drive File IDs', name: 'files', type: 'string', default: '', placeholder: '101, 102', description: 'Comma-separated IDs of Bitrix24 Drive files to attach. On Update the list replaces the current one.' },
